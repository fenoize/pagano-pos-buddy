-- ===================================================================
-- FASE 1: LIMPIEZA Y RESTRUCTURACIÓN DE BASE DE DATOS - CORREGIDA
...
-- Enum para tipo de movimiento de runas (creamos uno nuevo)
...
-- Crear constraint único para is_default por cliente
...
-- Cambiar el tipo de la columna type a usar el nuevo enum
ALTER TABLE runas_transactions 
ALTER COLUMN type TYPE runa_movement_type USING type::runa_movement_type;
...
-- ===================================================================
-- FIN DE MIGRACIÓN FASE 1 - CORREGIDA

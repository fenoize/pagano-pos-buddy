...
CREATE OR REPLACE FUNCTION public.update_order_status(p_order_id uuid, p_new_status text, p_user_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  VALUES (p_order_id, p_user_id, 'status', v_old_status, p_new_status, 'Cambio de estado');

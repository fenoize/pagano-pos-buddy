-- Modificar la función para que maneje NULL en p_user_id para pedidos de clientes
...
BEGIN
  ...
  -- Si p_user_id es NULL, usar cadena vacía para el contexto
  ...
  VALUES (
    ...
    p_user_id,  -- Puede ser NULL para pedidos desde app cliente
...
-- Eliminar la FK constraint si existe, ya que created_by_user_id puede ser NULL para pedidos de clientes

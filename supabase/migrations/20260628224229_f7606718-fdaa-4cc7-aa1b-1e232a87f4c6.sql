...
BEGIN
  ...
  -- Combo's own variant names (lowercase)
  ...
  -- Burger slot: combo_item whose default_product has variants whose names match the combo's variants
  burger_slot := NULL;
  ...
  -- Update each combo variant price by matching variant NAME against the burger slot
  FOR v IN

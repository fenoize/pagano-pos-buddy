...
BEGIN
  ...
  INSERT INTO public.orders (
    ...
    cash_given, receipt_number, operation_number,
    sales_channel_slug, external_order_id
  )
  VALUES (
    ...
    COALESCE((p_order_data->>'cash_given')::numeric, 0),
    NULLIF(p_order_data->>'receipt_number', ''),
    NULLIF(p_order_data->>'operation_number', ''),
    NULLIF(p_order_data->>'sales_channel_slug', ''),
    NULLIF(p_order_data->>'external_order_id', '')
  )

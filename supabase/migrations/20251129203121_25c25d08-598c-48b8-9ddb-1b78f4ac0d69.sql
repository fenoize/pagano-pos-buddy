-- Fix process_stock_adjustment to use correct enum value
...
DECLARE
  ...
  v_qty_out NUMERIC := 0;
BEGIN
  -- Determine quantities based on adjustment direction
  ...
  -- Record movement in stock_moves using 'adjustment' enum value

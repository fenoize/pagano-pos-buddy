-- ===================================================================
-- FASE 1: LIMPIEZA Y RESTRUCTURACIÓN DE BASE DE DATOS - FINAL
...
-- Constraint para email único en customers (solo si el email no es null)

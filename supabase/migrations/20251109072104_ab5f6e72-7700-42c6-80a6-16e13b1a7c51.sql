-- Corregir funciones RPC para pedidos online pasando user_id directamente

-- 1. Actualizar get_online_order_settings para recibir user_id
...
-- 2. Actualizar update_online_order_settings (ya recibe p_user_id pero falta validación correcta)
...
BEGIN
  ...
  -- Verificar que sea administrador usando la función que valida directamente

...
-- VERSIÓN LIMPIA: Elimina y recrea todas las estructuras necesarias
-- ============================================================================
...
-- 2.1 Eliminar completamente tablas antiguas (orden correcto para CASCADE)
DROP TABLE IF EXISTS recipe_ingredients CASCADE;
DROP TABLE IF EXISTS recipes CASCADE;
DROP TABLE IF EXISTS recipes_old_backup CASCADE;

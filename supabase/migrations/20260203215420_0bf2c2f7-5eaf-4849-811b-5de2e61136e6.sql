-- Fix ambiguous column reference in create_staff_session
...
BEGIN
  ...
  -- Return usando alias explícitos para evitar ambigüedad
  RETURN QUERY SELECT v_token AS token, v_expires_at AS expires_at;
END;
$function$;